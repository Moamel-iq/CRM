...
from abstract.utils.models import (
...
class Account(Timestamp):
    ...
    phone_number = PhoneNumberField(verbose_name='Phone Number', region="IQ", default="+964")
    industry = models.CharField(help_text='Industry Type: ', choices=INDUSTRYCHOICES, max_length=255,  blank=True, null=True)

    country = CountryField(default="IQ", verbose_name='Country')
    ...
    billing_country = CountryField(default="IQ", verbose_name='Country')

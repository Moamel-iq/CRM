from abstract.utils.models import ACCOUNT_TYPE
...
class Bank(Timestamp):
    ...
    signature_picture = models.ImageField(verbose_name = 'Signature Picture', upload_to = 'images/signature_pictures', null = True, blank = True)

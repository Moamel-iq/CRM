    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='images/product_images', verbose_name='Product Images')),
                ('barcode', models.ImageField(blank=True, null=True, upload_to='images/barcode_images', verbose_name='barcode/')),
                ('qrcode', models.ImageField(blank=True, null=True, upload_to='images/qrcode_images', verbose_name='qrcode/')),
                ...
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='product.unit')),
            ],
            options={
                'abstract': False,
            },

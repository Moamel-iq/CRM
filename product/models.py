...
class Product(Timestamp):
    ...
    image = models.ImageField('Product Images', null=True, blank=True, upload_to='images/product_images')
    barcode = models.ImageField('barcode/', blank=True, null=True, upload_to='images/barcode_images')
    qrcode = models.ImageField('qrcode/', blank=True, null=True, upload_to='images/qrcode_images')

...
class Product(Timestamp):
    ...
    image = models.ImageField('Product Images', null=True, blank=True,upload_to='images/products/image')
    barcode = models.ImageField('barcode/', blank=True, null=True, upload_to='images/products/barcode')
    qrcode = models.ImageField('qrcode/', blank=True, null=True, upload_to='images/products/qrcode')
    ...
    weight = models.CharField(
        verbose_name='Weight',
        max_length=10,
        help_text="The numeric or text version of the item's weight. Example: 1.5 lbs, 2.5 lbs, etc.", null=True,
        blank=True,
    )
